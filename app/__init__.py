...
def create_app(config_name=None):
    ...
    for bp in (main_bp,auth_bp,dashboard_bp,donations_bp,income_bp,expenses_bp,vendors_bp,budgets_bp,documents_bp,reports_bp,admin_bp,public_bp,controls_bp,health_bp):app.register_blueprint(bp)
