...
class Document(db.Model):
    ...
    doc_ref = db.Column(db.String(50), unique=True, nullable=False, index=True)
    ...
    current_sha256_hash = db.Column(db.String(64), nullable=False)
    ...
    versions = db.relationship(
        'DocumentVersion', backref='document', lazy=True,
...
class EvidencePack(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    pack_ref = db.Column(db.String(50), unique=True, nullable=False, index=True)
    title = db.Column(db.String(150), nullable=False)
    entity_type = db.Column(db.String(30), nullable=False)
    entity_id = db.Column(db.Integer, nullable=True)
