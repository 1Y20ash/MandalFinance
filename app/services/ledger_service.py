...
class LedgerService:
    ...
    def _generate_txn_ref():
        """Generate a unique transaction reference without relying on row counts."""
    ...
    def _lock_account(account_id):
        """Lock an account row when the database supports SELECT ... FOR UPDATE."""
    ...
    def _record(transaction_type, account_id, amount, description, source_module,
        ...
        try:
            ...
            transaction = Transaction(
                transaction_ref=LedgerService._generate_txn_ref(),
                event_id=event_id,
    ...
    def record_income(account_id, amount, description, source_module, source_id,
                      ...
                      category_id=None, event_id=None):
        return LedgerService._record(
            'INCOME', account_id, amount, description, source_module, source_id,
            created_by_id, payment_mode, external_ref, category_id, event_id
        )
    ...
    def record_expense(account_id, amount, description, source_module, source_id,
                       ...
                       category_id=None, event_id=None):
        return LedgerService._record(
            'EXPENSE', account_id, amount, description, source_module, source_id,
            created_by_id, payment_mode, external_ref, category_id, event_id
        )

    @staticmethod
    def reverse_transaction(transaction_id, reversed_by_user_id, reason):
        """Atomically create one offsetting reversal and mark the original as reversed."""
        ...
        try:
            ...
            existing_reversal = Transaction.query.filter_by(
